...
class AssetFormattingTest {
    ...
    private fun realEstate(
        interestType: com.atlasfpt.domain.model.InterestType? = null,
        fixedRate: Double? = null,
        referenceRate: com.atlasfpt.domain.model.ReferenceRate? = null,
        spread: Double? = null
    ) = com.atlasfpt.domain.model.RealEstateAsset(
        id = 1L,
        name = "x",
        currencyCode = "EUR",
        ...
        parish = "Alvalade",
        sizeM2 = 85.0,
        energyRating = com.atlasfpt.domain.model.EnergyRating.B
    )
    ...
    fun `describeInterest formats FIXED rate`() {
        val asset = realEstate(
            interestType = com.atlasfpt.domain.model.InterestType.FIXED,
            fixedRate = 3.2
        )
    ...
    fun `describeInterest formats VARIABLE with positive spread`() {
        val asset = realEstate(
            interestType = com.atlasfpt.domain.model.InterestType.VARIABLE,
            referenceRate = com.atlasfpt.domain.model.ReferenceRate.EURIBOR_12M,
            spread = 1.5
        )
